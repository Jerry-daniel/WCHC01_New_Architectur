/***********************************************************************************************************************
* File Name    : idt_id_confirmation_task.c
...
***********************************************************************************************************************/
unsigned char IDT_WPC_Id_Confirmation_Process(void);
/***********************************************************************************************************************
* Function Name: IDT_WPC_Id_Confirmation_Task
* Description  : This function is IDT_WPC_Id_Confirmation_Task function.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void IDT_WPC_Id_Confirmation_Task(void)
{
	if(IDT_WPC_State.Id_Confirmation_Task_Flag==TRUE)
	{
		IDT_WPC_State.Id_Confirmation_Task_Flag = FALSE;
		IDT_WPC_TASK = IDT_WPC_ID_CONFIRMATION_TASK;
	}
	IDT_WPC_TASK = IDT_WPC_Id_Confirmation_Process();
}
/***********************************************************************************************************************
