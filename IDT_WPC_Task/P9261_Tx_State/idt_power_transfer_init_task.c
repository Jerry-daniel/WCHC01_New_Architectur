/***********************************************************************************************************************
* File Name    : idt_power_transfer_init_task.c
...
***********************************************************************************************************************/
unsigned char IDT_WPC_Power_Transfer_Init_Process(void);
/***********************************************************************************************************************
* Function Name: IDT_WPC_Power_Transfer_Init_Task
* Description  : This function is IDT_WPC_Power_Transfer_Init_Task function.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void IDT_WPC_Power_Transfer_Init_Task(void)
{
	if(IDT_WPC_State.Power_Transfer_Init_Task_Flag==TRUE)
	{
		IDT_WPC_State.Power_Transfer_Init_Task_Flag = FALSE;
		IDT_WPC_TASK = IDT_WPC_POWER_TRANSFER_INIT_TASK;
	}
	IDT_WPC_TASK = IDT_WPC_Power_Transfer_Init_Process();
}
/***********************************************************************************************************************
* Function Name: IDT_WPC_Power_Transfer_Init_Process
* Description  : This function is IDT_WPC_Power_Transfer_Init_Process function.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
unsigned char IDT_WPC_Power_Transfer_Init_Process(void)
