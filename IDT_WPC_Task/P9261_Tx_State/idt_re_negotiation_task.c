/***********************************************************************************************************************
* File Name    : idt_re_negotiation_task.c
...
***********************************************************************************************************************/
unsigned char IDT_WPC_Re_Negotiation_Process(void);
/***********************************************************************************************************************
* Function Name: IDT_WPC_Re_Negotiation_Task
* Description  : This function is IDT_WPC_Re_Negotiation_Task function.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void IDT_WPC_Re_Negotiation_Task(void)
{
	if(IDT_WPC_State.Re_Negotiation_Task_Flag==TRUE)
	{
		IDT_WPC_State.Re_Negotiation_Task_Flag = FALSE;
		IDT_WPC_TASK = IDT_WPC_RE_NEGOTIATION_TASK;
	}
	IDT_WPC_TASK = IDT_WPC_Re_Negotiation_Process();
}
/***********************************************************************************************************************
* Function Name: IDT_WPC_Re_Negotiation_Process
* Description  : This function is IDT_WPC_Re_Negotiation_Process function.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
unsigned char IDT_WPC_Re_Negotiation_Process(void)
