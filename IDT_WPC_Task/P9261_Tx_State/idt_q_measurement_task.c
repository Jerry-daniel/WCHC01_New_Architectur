/***********************************************************************************************************************
* File Name    : idt_q_measurement_task.c
...
***********************************************************************************************************************/
unsigned char IDT_WPC_Q_Measurement_Process(void);
/***********************************************************************************************************************
* Function Name: IDT_WPC_Q_Measurement_Task
* Description  : This function is IDT_WPC_Q_Measurement_Task function.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
void IDT_WPC_Q_Measurement_Task(void)
{
	if(IDT_WPC_State.Q_Measurement_Task_Flag==TRUE)
	{
		IDT_WPC_State.Q_Measurement_Task_Flag = FALSE;
		IDT_WPC_TASK = IDT_WPC_Q_MEASUREMENT_TASK;
	}
	IDT_WPC_TASK = IDT_WPC_Q_Measurement_Process();
}
/***********************************************************************************************************************
* Function Name: IDT_WPC_Q_Measurement_Process
* Description  : This function is IDT_WPC_Q_Measurement_Process function.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
unsigned char IDT_WPC_Q_Measurement_Process(void)			// --- In Tx state 03 --- //
{
